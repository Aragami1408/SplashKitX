...
// keyboard input
SKX_API b8 skx_input_is_key_down(SKXKeys key);
SKX_API b8 skx_input_is_key_up(SKXKeys key);
SKX_API b8 skx_input_was_key_down(SKXKeys key);
SKX_API b8 skx_input_was_key_up(SKXKeys key);

void skx_input_process_key(SKXKeys key, b8 pressed);

// mouse input
SKX_API b8 skx_input_is_button_down(SKXButtons button);
SKX_API b8 skx_input_is_button_up(SKXButtons button);
SKX_API b8 skx_input_was_button_down(SKXButtons button);
SKX_API b8 skx_input_was_button_up(SKXButtons button);
SKX_API void skx_input_get_mouse_position(i32* x, i32* y);
SKX_API void skx_input_get_previous_mouse_position(i32* x, i32* y);
